...
%>
                                <form action="UserUpdatePro.us" id="join" method="post">
                                    ...
                                    <!-- Pass input-->
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="user_pass" type="pass"  name="pass" value="<%=dto.getUser_pass()%>"  readonly />
                                        <label for="pass">비밀번호</label>
                                    </div>
                                    <!-- Name input-->
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="user_name" type="text" name="name" value="<%=dto.getUser_name()%>" />
                                        <label for="name"> <i class="bi bi-star-fill text-warning"></i> 이름</label>
                                    </div>
                                    <!-- Email address input-->
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="user_email" type="email" name="email" value="<%=dto.getUser_email()%>"/>
                                        <label for="email"><i class="bi bi-star-fill text-warning"></i> 이메일</label>
                                    </div>
                                    <!-- Phone number input-->
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="user_phone" type="tel" name="phone" value="<%=dto.getUser_phone()%>"/>
                                        <label for="phone"><i class="bi bi-star-fill text-warning"></i> 전화번호</label>
                                    </div>
                                    <!-- birth input-->
                                     <div class="form-floating mb-3">
                                        <input class="form-control" id="user_birth" type="text" name="birth" value="<%=dto.getUser_birth()%>"/>

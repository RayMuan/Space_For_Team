            ...
            <div class="row gx-4 gx-lg-5 align-items-center my-5">
                <div class="col-lg-5">
                     ...
                     <%	
						...
						%>		
                    <div class="h6 fw-bolder">관리자 <b><%=id %></b>님,</div></br>
                </div>
            </div>
            <!-- Call to Action-->
                    ...
                    <div class="row gx-5 justify-content-center">
                        <div class="col-lg-8 col-xl-6">
                            <div class="text-center">
                                ...
                                <p class="lead fw-normal text-muted mb-5">spaceforteam에 등록된 모든 공간내역입니다.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row gx-5">
        ...
        <div class="card-footer p-4 pt-0 bg-transparent border-top-0">
            <div class="d-flex align-items-end justify-content-between">                    
			  ...
			  <div style="text-align:center;">
				<input type="button" name="delete" value="삭제" onclick="location.href='AdminSpaceDeleteForm.sp?s_num=<%=dto.getS_num()%>'">

<%@page import="com.space4team.space.db.ReviewDTO"%>
...
<div class="selmain" >  
 <form name="form1">
  ...
  <select class="form-control" style="text-align:left; width:150px; height:35px;" name="h_area1" onChange="cat1_change(this.value,h_area2)" >
...
<option value='16'>충북</option>
  ...
  <select class="form-control" style="text-align:left; width:150px; height:35px;" name="h_area2">

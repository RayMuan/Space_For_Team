...
public class InsertDAO {
	...
	public void insertMember(InsertDTO dto) { 
		Connection con = null;
		...
		try {
			...
			sql = "insert into user(user_num,user_email, user_id ,user_name,user_pass,user_pass1,user_phone,user_birth) values(?,?,?,?,?,?,?,?)";
			...
			pstmt.setString(6, dto.getUser_pass1());
			pstmt.setString(7, dto.getUser_phone());
			pstmt.setString(8, dto.getUser_birth());
//			pstmt.setTimestamp(7, dto.getDate());
	...
	public InsertDTO getMember(String id) {
		InsertDTO dto=null;
		Connection con =null;
		PreparedStatement pstmt=null;
		ResultSet rs=null;
		try {
			...
			if(rs.next()){
				...
				dto.setUser_pass1(rs.getString("user_pass1"));
